...
function findMaxCount(inputObject){
  let max=0;
  let maxName=null;
...
function findDominantDirection(textInput){
  let directions =  countBy(textInput,(letter)=>{
    if(characterScript(letter.codePointAt(0))==null) return null;
    return characterScript(letter.codePointAt(0)).direction;});
    return findMaxCount(directions);
}

console.log(findDominantDirection("Hello!"));
// ltr
console.log(findDominantDirection("Hey, مساء الخير"));
// rtl
console.log(findDominantDirection("Strangers, مساء الخير"));
// ltr
console.log(findDominantDirection(""));
// null
