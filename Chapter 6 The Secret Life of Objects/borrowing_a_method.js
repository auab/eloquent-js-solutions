...
let mapTest = {one: true, two: true, hasOwnProperty: 2};

console.log(Object.prototype.hasOwnProperty.call(mapTest, 'one'));
//true
console.log(Object.prototype.hasOwnProperty.call(mapTest, 'three'));
//false